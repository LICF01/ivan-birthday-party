				...
				<div className='max-w-xl mx-auto'>
					...
					<div className='info  text-center text-2xl'>
						<p className='text  my-5'>
							Soy el mayor de los denominados planetas rocosos,
							gracias a que poseo gran cantidad de agua se pudo
							formar vida, mi nombre proviene del latín “Terra”.
						</p>
						<p className='text  my-5'>
							...
							, esto se debe a que la suite representa a los
							planetas que se podían ver desde la tierra en esa
							época.
						</p>
					</div>
				</div>
