				...
				<div className='max-w-xl mx-auto'>
					...
					<div className='info  text-center text-2xl'>
						<p className='text  my-5'>
							Además de ser el más pequeño, soy el primer planeta
							del sistema solar, por lo que soy el más cercano al
							sol.
						</p>
						<p className='text  my-5'>
							En la
						...
						<p className='text  my-5'>
							Soy el último y más corto de los siete movimientos y
							se destacan el violín solista, el arpa aguda, la
							flauta y el glockenspiel.
						</p>
					</div>
				</div>
			</div>
