				...
				<div className='max-w-xl mx-auto'>
					...
					<div className='info  text-center text-2xl'>
						<p className='text  my-5'>
							Soy uno de los planetas enanos del sistema solar, mi
							nombre hace referencia al dios griego Hades.
						</p>
						<p className='text  my-5'>
							Por mi pequeño tamaño y gran distancia respecto al
							sol, recién en 2015 la sonda
							<a
							...
							permitió apreciar por primera vez de forma nítida mi
							aspecto real.
						</p>
						<p className='text  my-5'>
							...
							ya que aún no había sido descubierto cuando fué
							escrita.
						</p>
					</div>
				</div>
